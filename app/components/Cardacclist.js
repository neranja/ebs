...
function Cardacclist({navigation,token,branchId,accountNumber,accStatus,accountType,balance}) {
   console.log(accountNumber);
    return (
        ...
        <View style={styles.card}>
            ...
            <AppText style={styles.title}>&nbsp;&nbsp;&nbsp;{"Account type : "}&nbsp;</AppText>
...
/>
            ...
            <AppText style={{color:colors.green}}>&nbsp;&nbsp;&nbsp;{accStatus}&nbsp;</AppText>
            <AppText style={styles.title}>&nbsp;&nbsp;&nbsp;{"Balance : "}&nbsp;</AppText>
