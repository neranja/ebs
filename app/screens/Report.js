...
const validationSchema=Yup.object().shape({
    accountNo:Yup.string().required().label("Account No"),
    amount:Yup.string().required().label("Amount"),
   // password:Yup.string().required().min(4).label("Password")
  })

function Report({navigation,route,token,branchId1,id}) {
  ...
  var id=route.params.params.id;
   ...
   const [date, setDate] = useState('2022-12-19')
    ...
    return (
        ...
        <Screen style={styles.screen}>
          <View style={styles.container}>
            ...
            <View >
            <AppText style={styles.title}>Daily reports</AppText>
            </View>
